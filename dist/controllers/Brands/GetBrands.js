...
function getBrand(_x, _x2) {
  return _getBrand.apply(this, arguments);
}
function _getBrand() {
  _getBrand = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var id, brand, brands;
      ...
      while (1) switch (_context.prev = _context.next) {
        ...
        case 17:
          ...
          return _context.abrupt("return", res.status(500).json({
            message: 'Ocorreu um erro ao buscar marcas.'
          }));
        case 20:
        case "end":
