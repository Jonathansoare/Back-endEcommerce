...
function GetFavorite(_x, _x2) {
  return _GetFavorite.apply(this, arguments);
}
function _GetFavorite() {
  _GetFavorite = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var id, whereCondition, favorites, productIds, productsDetails, productsMap, favoritesWithProducts;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 9:
          productIds = favorites.map(function (favorite) {
          ...
          return Products.findAll({
            ...
            attributes: ['id', 'name', 'price', 'BrandName', 'description', 'quantityInStock', 'type', 'rating'],
            // Campos desejados para os produtos
            include: [{
              model: Imagens,
        ...
        case 12:
          productsDetails = _context.sent;
          // Mapear os detalhes dos produtos por id para facilitar o acesso
          productsMap = {};
          productsDetails.forEach(function (product) {
          ...
          favoritesWithProducts = favorites.map(function (favorite) {
            var productDetails = productsMap[favorite.productId];
            return {
              id: favorite.id,
