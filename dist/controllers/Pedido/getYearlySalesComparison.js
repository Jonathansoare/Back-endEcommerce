...
var getYearlySalesComparison = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var totalVendasAnoAtual, totalVendasAnoAnterior, diferencaPercentual;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 12:
          ...
          console.error('Erro ao buscar vendas anuais e calcular a diferença percentual:', _context.t0);
          return _context.abrupt("return", res.status(500).json({
            error: 'Erro ao buscar vendas anuais e calcular a diferença percentual'
          }));
        case 16:
        case "end":
  ...
  return function getYearlySalesComparison(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();
module.exports = {
  getYearlySalesComparison: getYearlySalesComparison
};