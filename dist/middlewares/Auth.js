...
module.exports = {
  eAdmin: function () {
    var _eAdmin = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res, netx) {
      var authHeader, _authHeader$split, _authHeader$split2, token, decode;
    ...
    function eAdmin(_x, _x2, _x3) {
      return _eAdmin.apply(this, arguments);
    }
    return eAdmin;
  }()
};